DELETE FROM [Bonava-Test].[dbo].[Real Estate$Salesperson_Purchaser$437dbf0e-84ff-417a-965d-ed2bb9650972];
...
FROM [VM-PRO-SQL007\NAV].[NAV_for_Developers].[dbo].[NCC Real Estate$Salesperson_Purchaser] AS SalespersonPurchaser
